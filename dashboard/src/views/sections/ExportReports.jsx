  ...
  return (
    <section className="space-y-6">
      ...
      <div className="grid-2col">
        {/* Individual Export */}
        <GlassCard style={{ padding: 'var(--space-8)', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
          <div>
            ...
            <p style={{ fontSize: 'var(--text-sm)', color: 'var(--color-text-muted)', marginBottom: 'var(--space-6)' }}>
              Download the complete JSON vector for a specific team member, including their scores, breakdown, and coaching summary.
            </p>
          ...
          <Button onClick={handleExportPerson} className="btn-full">
            <IconDownload />
            Download {selectedV?.name}'s Report
          </Button>
        </GlassCard>
        ...
        <GlassCard style={{ padding: 'var(--space-8)', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-3)', marginBottom: 'var(--space-4)' }}>
              <div className="export-card-icon info-bg">
                <IconUsers />
              </div>
              <h4>Full Team Data</h4>
            </div>
            <p style={{ fontSize: 'var(--text-sm)', color: 'var(--color-text-muted)', marginBottom: 'var(--space-6)' }}>
              Download the aggregated JSON array containing vectors for every team member in the {project?.name} repository.
            </p>
          </div>
